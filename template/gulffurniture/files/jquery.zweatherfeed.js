		...
		return this.each(function(i, e) {
			...
			var _process = function(e, feed, options) {
				...
				if (feed.description != 'Yahoo! Weather Error') {
					...
					if (options.forecast) {
						html += '<div style="clear:both; overflow:auto"><a class="day-nav">Thu</a><a class="day-nav">Fri</a><a class="day-nav">Sat</a><a class="day-nav">Sun</a><a class="day-nav">Mon</a></div>';
